// Archived from packages/core/src/checkpoint.test.ts — the tests for the pin/unpin/
// retention-floor/rewind surface. The ordered-listing test for the live
// `checkpoint`/`listTimeline` surface stayed in the tree.
