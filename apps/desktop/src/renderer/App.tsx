...
export function App(): React.JSX.Element {
  ...
  // The active session always has a tab: seed/append on every genuine change of the
  // session slice's activeSessionId (boot-time open, browser pick, new session). The
  // shell's tab set is also the materialization trigger — the controller subscribes to
  // it, so opening the tab keeps that session subscribed + hydrated from then on.
  useEffect(() => {
