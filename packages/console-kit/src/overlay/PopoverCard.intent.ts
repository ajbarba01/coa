...
export const popoverCardIntent: ComponentIntent = assertIntent({
  name: 'PopoverCard',
  family: 'Overlays',
  intent: 'A trigger-anchored floating card on Base UI mechanics, wearing the shared menu-surface skin.',
  useWhen: [
  ...
  variantsStates: ['closed', 'open (positioned side/align, mount rise)', 'reduced-motion (instant)'],
