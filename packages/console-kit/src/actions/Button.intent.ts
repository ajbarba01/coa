...
export const buttonIntent: ComponentIntent = assertIntent({
  name: 'Button',
  family: 'Actions',
  intent: 'The six-variant action vocabulary — primary/quiet/outline/block/ghost/text pick the weight, icon swaps text padding for square icon geometry.',
  useWhen: [
  ...
  variantsStates: [
    ...
    'ghost',
    'text',
    'default · hover · focus-visible (global interior ring) · active (scale press) · disabled (no hover, no pointer)',
  ],
  accessibility:
