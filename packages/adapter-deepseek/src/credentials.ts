 ...
 * back to the {@link DEFAULT_API_KEY_VAR} env var. `readKeyFile` is injectable for
 * tests. Account-switching selects which key is live without coa persisting one in
 * its account list.
 */
